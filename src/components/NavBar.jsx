    ...
    <div className="bg-navBar h-full w-12 flex flex-col items-center justify-between text-gray-600 border-r-[1px] border-gray-900">
      <div className="w-full">
        ...
        <WithTooltip text={t('navBar.link.mail')}>
          <a href="mailto:thmarinho@outlook.fr">
            <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        ...
        <WithTooltip text={t('navBar.link.linkedin')}>
          <a href="https://www.linkedin.com/in/thmarinho" target="_blank">
        ...
        <WithTooltip text={t('navBar.link.github')}>
          <a href="https://github.com/thmarinho" target="_blank">
