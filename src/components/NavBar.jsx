  ...
  return (
    <div className="bg-navBar min-w-12 h-12 sm:h-full sm:w-12 flex sm:flex-col items-center justify-between text-gray-600 border-r-1 border-gray-900">
      <div className="w-full flex sm:block justify-evenly sm:justify-start">
        <button onClick={toggleExplorer} className="sm:w-full sm:aspect-square items-center justify-center hidden sm:flex" title={t('navbar.link.profile')}>
        ...
        <WithTooltip text={t('navBar.link.github')}>
          <a href="https://github.com/thmarinho" target="_blank" rel="noreferrer" title={t('navBar.link.github')}>
            <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" aria-hidden="true">
        ...
        <WithTooltip text={t('navBar.link.linkedin')}>
          <a href="https://www.linkedin.com/in/thmarinho" target="_blank" rel="noreferrer" title={t('navBar.link.linkedin')}>
            <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" aria-hidden="true">
        ...
        <WithTooltip text={t('navBar.link.mail')} className="block sm:hidden">
          <a href="mailto:thmarinho@outlook.fr" target="_blank" rel="noreferrer" title={t('navBar.link.mail')}>
            <EnvelopeIcon className="w-6 h-6" strokeWidth="2" aria-hidden="true" />
          </a>
        </WithTooltip>
      </div>
      <div className="w-full hidden sm:block">
        ...
        <Icon className="group">
          <Cog8ToothIcon className="w-6 h-6" strokeWidth="2" aria-hidden="true" />
          <div className="
            hidden
